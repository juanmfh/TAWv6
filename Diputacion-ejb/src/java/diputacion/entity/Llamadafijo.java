...
public class Llamadafijo implements Serializable {
    ...
    @JoinColumn(name = "llamada_recuperada", referencedColumnName = "idlineaFija")
    @ManyToOne(optional = false)
    private Lineafija llamadaRecuperada;
    ...
    public Lineafija getLlamadaRecuperada() {
        return llamadaRecuperada;
    }

    public void setLlamadaRecuperada(Lineafija llamadaRecuperada) {
        this.llamadaRecuperada = llamadaRecuperada;
    }
    ...
    public String toString() {
        return "diputacion.entity.Llamadafijo[ idllamadaFijo=" + idllamadaFijo + " ]";
    }
